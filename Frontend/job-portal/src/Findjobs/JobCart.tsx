...
const JobCart = (jobDetails: any) => {
  return (
    <Link
      ...
      className="bg-mine-shaft-700 min-h-[300px] p-4 w-72 flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !bright-sun-400 cursor-pointer"
    >
      ...
      <div className="flex justify-between text-sm ">
        ...
        <div className="flex items-center gap-1 text-mine-shaft-300">
         ...
         Posted: { timeAgo(jobDetails.postTime)} 
        </div>
      </div>
    </Link>
  );
